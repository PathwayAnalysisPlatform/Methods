...
public class SearchResult {
    ...
    Set<Proteoform> getMatchedProteoforms() {
    ...
    public void calculateHitGenes(Mapping mapping) {
        for (String protein : hitProteins) {
            hitGenes.addAll(mapping.getProteinsToGenes().get(protein));
        }
    }

    public void calculateHitProteoforms(Mapping mapping) {
        for (String protein : hitProteins) {
            hitProteoforms.addAll(mapping.getProteinsToProteoforms().get(protein));
        }
    }
